...
import com.example.coroutinemultithread.databinding.ActivityMultiThreadBinding
...
class MultiThreadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_multi_thread)
